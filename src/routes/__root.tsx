  ...
  head: () => ({
    meta: [
      ...
      { title: "Md. Ashikur Rahman — WordPress & Elementor Web Developer" },
      {
        name: "description",
        content:
          "Premium WordPress, Elementor & AI-assisted web development for businesses worldwide. Hire Md. Ashikur Rahman.",
      },
      { name: "author", content: "Md. Ashikur Rahman" },
      {
        property: "og:title",
        content: "Md. Ashikur Rahman — WordPress & Elementor Web Developer",
      },
      {
